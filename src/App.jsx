...
import SaleBillPrint1 from './Component/Branch1/SaleBillPrint/SaleBillPrint';
...
const router = createBrowserRouter([
  ...
  {
    path: '/Component/Branch1/SaleBillPrint/SaleBillPrint/:id',
    element: <Layout1><SaleBillPrint1 /></Layout1>
  },
  {
